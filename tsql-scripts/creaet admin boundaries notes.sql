...
-- raw_admin_bdys.aus_state
-- raw_admin_bdys.aus_comm_electoral
-- raw_admin_bdys.aus_comm_electoral_polygon
-- raw_admin_bdys.aus_state_electoral
-- raw_admin_bdys.aus_state_electoral_polygon
-- raw_admin_bdys.aus_state_electoral_class_aut
-- raw_admin_bdys.aus_lga
-- raw_admin_bdys.aus_wards

CREATE SCHEMA raw_admin_bdys;
--------------------------------------------------------------------------------------
-- locality boundaries
--------------------------------------------------------------------------------------
CREATE SCHEMA admin_bdys;

DROP TABLE IF EXISTS admin_bdys.locality_bdys;
CREATE TABLE admin_bdys.locality_bdys(
  gid INT NOT NULL IDENTITY PRIMARY KEY,
...
SELECT loc_pid,
       ...
       state,
       loc_class,
       geom.STUninon.STBuffer(geom, 0.0)
...
DROP TABLE IF EXISTS admin_bdys.postcode_bdys;
...
DROP TABLE IF EXISTS admin_bdys.state_bdys;
...
DROP TABLE IF EXISTS admin_bdys.commonwealth_electorates;
...
DROP TABLE IF EXISTS admin_bdys.state_lower_house_electorates;
...
DROP TABLE IF EXISTS admin_bdys.state_upper_house_electorates;
...
DROP TABLE IF EXISTS admin_bdys.local_government_areas;
...
DROP TABLE IF EXISTS admin_bdys.local_government_wards;
